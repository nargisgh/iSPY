...
initialize the theme, images(from Flickr), or game play mode chosen and shuffle before game play.
Win by matching the correct picture or word(if word + image game play is chosen) in record time.
When the game is over  the on touch feature will pop up a screen allowing  you to view your score and save or continue.
The user can view high scores to beat and save their own scores to make it to the top 5; they can view or reset the scores before
or after playing the game. Each order and draw pile size will have different default scores to beat.
Help screen explains the rules and conventions of the game in detail with sources provided.
...
## Key Features
    ...
    * Options allows user to choose draw pile size based on order and vice versa
    * Invalid option of draw pile size or order will be red to block user from selecting it
